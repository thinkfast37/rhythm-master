...
- **AC-2.6.1** — A progression is chosen from a catalogue of named progressions
  ...
  - **Cases**:
    - **AC-2.6.1/1** — The picker offers None first, then every catalogue entry under seven group headings in this order: Three chords and repeats, Pop, Minor, Jazz, Blues, Modal and rock, Classical and folk
