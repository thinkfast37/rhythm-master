...
| US-4.1 | `AC-4.1.1` | Playback stays sample-accurate over long loops | P-010 | T051, T052, T053, T054, T055, T165, T220, T228, T230 (9/9 done) | T056, T165, T221, T229, T231 (5/5 done) | `timeline.test.js`, `playback.spec.js` | 🔴 **HIGH** · WRONG TEST ᵃ |
...
| US-4.2 | `AC-4.2.1` 🖵 | Default tempo and range | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
| US-4.2 | `AC-4.2.2` | Tempo change restarts playback immediately | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟠 **MEDIUM** · NEEDS CASES ᵃ |
| US-4.2 | `AC-4.2.3` | Tempo default: global last-used, overridden by a per-Pattern save | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `storage.test.js`, `playback.spec.js` | 🟠 **MEDIUM** · NEEDS CASES ᵃ |
| US-4.2 | `AC-4.2.4/1` | A shipped Pattern's tempo change is applied again when the Pattern is next loaded, surviving a reload | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
| US-4.2 | `AC-4.2.4/2` | The remembered tempo lives in the overlay store and the shipped Pattern's own data is unchanged | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
| US-4.2 | `AC-4.2.5/1` 🖵 | A typed BPM applies exactly, and the slider follows it | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
| US-4.2 | `AC-4.2.5/2` 🖵 | A typed value outside 18–300 clamps to the nearer bound, and a non-numeric entry leaves the tempo unchanged | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
| US-4.2 | `AC-4.2.5/3` 🖵 | The field always shows the current tempo, however it was last set — slider, preset, or typing | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
| US-4.2 | `AC-4.2.6/1` 🖵 | The preset row offers exactly those fourteen values, in ascending order | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
| US-4.2 | `AC-4.2.6/2` 🖵 | Tapping the 300 preset sets the tempo to the ceiling | P-011 | T057, T058, T204, T234 (4/4 done) | T059, T205, T235 (3/3 done) | `playback.spec.js` | 🟢 OK |
...
| US-4.4 | `AC-4.4.1` | Swing default and range | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `swing.test.js` | 🔴 **HIGH** · WRONG TEST ᵃ |
| US-4.4 | `AC-4.4.2` 🖵 | Swing is set per Subdivision Group independently | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `swing.test.js` | 🔴 **HIGH** · WRONG TEST ᵃ |
| US-4.4 | `AC-4.4.3` 🖵 | Triplet-feel groups have no swing control | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `swing.test.js`, `timeline.test.js` | 🔴 **HIGH** · NOT PROVABLE ᵃ |
| US-4.4 | `AC-4.4.4` | Swing only affects the straight portion of a mixed Beat | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🔴 **HIGH** · WRONG TEST ᵃ |
| US-4.4 | `AC-4.4.5` | Swing timing formula | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `swing.test.js` | 🔴 **HIGH** · WRONG TEST ᵃ |
| US-4.4 | `AC-4.4.6/1` 🖵 | Changing swing on a shipped Pattern shows no naming prompt and creates no new Pattern | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.6/2` 🖵 | The swing set on a shipped Pattern is applied again when it is next loaded, surviving a reload | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.6/3` 🖵 | The remembered swing lives in the overlay store and the shipped Pattern's own data is unchanged | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.6/4` 🖵 | A playback swing does not give a shipped Pattern the `swing` Tag in the library | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.7/1` 🖵 | The Swing feel control offers Quarters, 8ths, and 16ths, with 8ths selected by default | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `swing.test.js`, `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.7/2` 🖵 | The feel is one value for the whole Pattern | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.7/3` 🖵 | Selecting a feel takes effect immediately, with no confirmation step | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.8/1` | In a 4-Slot straight group, the Slots at positions 2 and 4 each onset later by min(S / 100 × d, 0.95 × d) seconds, while positions 1 and 3 keep their nominal onsets | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `swing.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.8/2` | A 2-Slot straight group keeps every nominal onset at the 16ths feel | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `swing.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.8/3` | Triplet-feel groups keep their unshifted timing at the 16ths feel | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.9/1` | Every sounding Slot in the second Beat of a pair onsets later by min(S / 100 × D, 0.95 × D) seconds, with the Beat's internal spacing unchanged | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.9/2` | The first Beat of each pair, and the unpaired final Beat of an odd-numerator Measure, keep their nominal onsets | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.9/3` | Pairing restarts at each Measure's first Beat | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.10/1` 🖵 | Changing the swing feel on a shipped Pattern shows no naming prompt and creates no new Pattern | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.10/2` 🖵 | The feel set on a shipped Pattern is applied again when it is next loaded, surviving a reload | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.10/3` 🖵 | The remembered feel lives in the overlay store and the shipped Pattern's own data is unchanged | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.10/4` 🖵 | A swing feel alone never grants or removes the `swing` Tag | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.10/5` 🖵 | On an owned Pattern the swing feel saves into the Pattern itself | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.11/1` | Patterns differing only in swing feel are not duplicates when any swing amount is above 0 | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `similarity.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.11/2` | Patterns differing only in swing feel remain duplicates when every swing amount is 0 | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `similarity.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.12/1` 🖵 | The swing control's amount reaches every Measure and Beat of the Pattern | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.12/2` 🖵 | A Measure added after swing is set inherits the amount with no further action | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.12/3` 🖵 | The Pattern-wide amount set on a shipped Pattern is applied again when it is next loaded, surviving a reload | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.13/1` | Every straight Subdivision Group in every Measure and Beat swings by the Pattern-wide amount | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.13/2` | A Measure added after the Pattern-wide amount is set inherits it | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.13/3` | A Beat whose Recipe changes after the Pattern-wide amount is set inherits it | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.13/4` | A per-group amount takes precedence over the Pattern-wide amount for its own group | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `timeline.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.13/5` | A Pattern-wide amount above 0 carries the `swing` Tag, and 0 with no per-group amounts removes it | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `pattern.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.13/6` | A Pattern-wide amount and per-group amounts spelling out the same values fingerprint as the same rhythm | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `similarity.test.js` | 🟢 OK |
| US-4.4 | `AC-4.4.14/1` 🖵 | An all-triplet Pattern shows no swing amount control and no Swing feel control | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.14/2` 🖵 | An all-triplet Pattern shows one note explaining swing doesn't apply to triplet feel | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.14/3` 🖵 | A Pattern with a straight-feel group shows both swing controls and no note, all-Undivided Patterns included | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.15/1` 🖵 | The swing preset row offers exactly 0, 15, 25, 33 and 50, in ascending order | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.15/2` 🖵 | Tapping a swing preset sets the Pattern-wide amount and clears per-group overrides, exactly as the slider does | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.15/3` 🖵 | On an all-triplet Pattern the preset row is absent along with the other swing controls (AC-4.4.14) | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.16/1` 🖵 | A typed amount applies exactly, and the slider follows it | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.16/2` 🖵 | A typed value outside 0–100 clamps to the nearer bound, and a non-numeric entry leaves the amount unchanged | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
| US-4.4 | `AC-4.4.16/3` 🖵 | The field always shows the current amount, however it was last set — slider, preset, or typing | P-013 | T063, T204, T206, T210, T222, T236 (6/6 done) | T064, T205, T207, T211, T223, T237 (6/6 done) | `playback.spec.js` | 🟢 OK |
